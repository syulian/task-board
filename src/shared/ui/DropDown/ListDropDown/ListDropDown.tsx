    ...
    return (
        <ul className="flex flex-col" role="menu">
            {list.map((l, i) => (
                <li key={i}>
                    {l.title && (
                        <p className="text-text-secondary font-semibold py-1 px-4 border-b border-bg-neutral pb-2 mb-2">
                            {l.title}
                        </p>
                    )}
                    <ul
                    ...
                    >
                        {l.children.map((c, i) => (
                            <li key={i}>
                                <button
                                    onClick={c.onClick}
                                    className="flex justify-between items-center cursor-pointer hover:bg-bg-neutral py-1 px-4 rounded-sm text-text-primary w-full text-left"
                                    role="menuitem"
                                >
                                    {c.label}
                                </button>
